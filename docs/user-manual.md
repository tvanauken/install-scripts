...
2. Navigate to `https://<YOUR_SERVER_IP>:9090` (e.g., `https://192.168.200.141:9090`).
...
*   **Virtual Machines:** If you are running this UI in a Proxmox VM with HBA pass-through, the interface has been specifically optimized to render the full physical chassis layout.
