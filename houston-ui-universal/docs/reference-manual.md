# Van Auken Tech - Houston / 45Drives - Universal Installer - Reference Manual

## Installer Architecture (V6.0.0)
This reference manual outlines the critical infrastructure logic implemented in the `houston-universal-v1.0.0.sh` V6 script.
